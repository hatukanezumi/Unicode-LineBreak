...
(L<Unicode::GCString|POD2::JA::Unicode::GCString> も参照)、行分割動作 ([B<L>])
に影響するものがある。
...
L<Unicode::GCString|POD2::JA::Unicode::GCString> 参照。
...
このモジュールで用いている文字の特性値は、Unicode 標準 6.3.0版のベータ版による。
...
A. Freytag and A. Heninger (2008-2013).
I<Unicode Standard Annex #14: Unicode Line Breaking Algorithm>, Revisions 22-31.
L<http://unicode.org/reports/tr14/>.

=item [UAX #29]

Mark Davis (2009-2013).
I<Unicode Standard Annex #29: Unicode Text Segmentation>, Revisions 15-22.
...
L<Text::LineFold|POD2::JA::Text::LineFold>,
L<Text::Wrap>,
L<Unicode::GCString|POD2::JA::Unicode::GCString>.
