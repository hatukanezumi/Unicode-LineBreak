...
文字列または L<MIME::Charset|POD2::JA::MIME::Charset> オブジェクト。
初期値は C<"UTF-8">。
...
初期値は C<"XX">。
L<Context in Unicode::LineBreak|POD2::JA::Unicode::LineBreak/Context> オプションも参照。
...
L<オプション in Unicode::LineBreak|POD2::JA::Unicode::LineBreak/オプション> を参照。
...
L<Unicode::LineBreak|POD2::JA::Unicode::LineBreak>,
L<Text::Wrap>.
