...
I<beta release of> Unicode Standard version 6.3.0.

B<NOTE: Current release of this module is development release.
It should not be applied to production use>.
