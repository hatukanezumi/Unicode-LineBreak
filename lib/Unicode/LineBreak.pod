...
For example, following code inserts hyphen to the name of several chemical substances (such as Titin) so that it may be folded:
    ...
    print $lb->break("Methionylthreonylthreonylglutaminylarginyl...");
...
Following characters behave as if they were CM.

    UCS    |Name                                |LB |GCB
    ------------------------------------------------------------
    U+034F |COMB. GRAPHEME JOINER               |GL |Extend
    U+035C |COMB. DOUBLE BREVE BELOW            |GL |Extend
    U+035D |COMB. DOUBLE BREVE                  |GL |Extend
    U+035E |COMB. DOUBLE MACRON                 |GL |Extend
    U+035F |COMB. DOUBLE MACRON BELOW           |GL |Extend
    U+0360 |COMB. DOUBLE TILDE                  |GL |Extend
    U+0361 |COMB. DOUBLE INVERTED BREVE         |GL |Extend
    U+0362 |COMB. DOUBLE RIGHTWARDS ARROW BELOW |GL |Extend
    U+0F7F |TIBETAN SIGN RNAM BCAD (visarga)    |BA |SpacingMark
    U+FF9E |HW. KATAKANA VOICED SOUND MARK      |NS |Extend
    U+FF9F |HW. KATAKANA SEMI-VOICED SOUND MARK |NS |Extend
    ------------------------------------------------------------
