...
By default, no tailorings are available.
See also L</Tailoring Character Classifications>.
...
=head2 Tailoring Character Classifications

Character classifications may be tailored by L</TailorLB> and L</TailorEA>
...
Extended or SpacingMark be resolved to CM.
