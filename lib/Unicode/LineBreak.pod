...
STRING.
See L</Constants> for returned value.
Classes AI, CJ, SA, SG and XX will be resolved to other
appropriate classes. 
...
are treated as nonstarters (NS or CJ).
...
currently proposed draft of [UAX14].
...
and as Class 13 (corresponding to ID) by [JIS X 4051] and [JLREQ].
...
Unicode Standards version 6.1.0-beta at 15 Dec. 2011.
...
L<http://www.w3.org/TR/2011/WD-jlreq-20111129/>.
