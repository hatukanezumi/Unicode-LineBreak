...
PROPERTY is one of East_Asian_Width property values N, Na, W, F and H
(See L</Constants>).
...
=item C<LB_BK>, C<LB_CR>, C<LB_LF>, C<LB_NL>, C<LB_SP>, C<LB_OP>, C<LB_CL>, C<LB_CP>, C<LB_QU>, C<LB_GL>, C<LB_NS>, C<LB_EX>, C<LB_SY>, C<LB_IS>, C<LB_PR>, C<LB_PO>, C<LB_NU>, C<LB_AL>, C<LB_ID>, C<LB_HL>, C<LB_IN>, C<LB_HY>, C<LB_BA>, C<LB_BB>, C<LB_B2>, C<LB_CB>, C<LB_ZW>, C<LB_CM>, C<LB_WJ>, C<LB_H2>, C<LB_H3>, C<LB_JL>, C<LB_JV>, C<LB_JT>, C<LB_SG>, C<LB_AI>, C<LB_SA>, C<LB_XX>

Index values to specify 38 line breaking properties (classes)
defined by [UAX #14].

B<Note>: Property value CP was introduced by Unicode 5.2.0.
Property value HL may be introduced by Unicode 6.1.0.
...
=head4 Nonstarters of Kana-like Characters
...
Unicode Standards version 6.1.0-beta at 19 Sep. 2011.
B<This data is beta release.  Do not use for production system>.
...
A. Freytag (2008-2011).
I<Unicode Standard Annex #11: East Asian Width>, Revision 17-22.
L<http://unicode.org/reports/tr11/>.

=item [UAX #14]

A. Freytag and A. Heninger (2008-2011).
